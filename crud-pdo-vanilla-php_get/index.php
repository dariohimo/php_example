...
<body class="py-3">
    ...
    <div class="row">
        ...
        <div class="col">
            <h1>Editar</h1>
            <a href="cambiar.php?id=<?php echo $fila['id'] ?>" class="btn btn-warning float-rigth"> Editar producto </a>
        </div>
            ...
            <table class="table table-dark table-hover">
                <thead>
                    <tr>
                        ...
                        <th>Nombre</th>
                        <th>Precio</th>
                        <th class="bg-warning"><a href="cambiar.php?id=<?php echo $fila['id'] ?>"> Editar</a> </th>
                ...
                <tbody>
                    <?php foreach($resultado AS $fila){ ?>
                        <tr>
                            ...
                            <td> <a href="edit.php?=<?php echo $id['id'] . 12 ?>">  <?php echo $fila['nombre'] ?>  </a> </td>
